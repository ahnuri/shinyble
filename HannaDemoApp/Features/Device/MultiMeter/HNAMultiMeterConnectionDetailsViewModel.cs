...
public partial class HNAMultiMeterConnectionDetailsViewModel : ObservableObject
{
    ...
    [ObservableProperty]
    private string deviceDisplayName = "MultiMeter";

    [ObservableProperty]
    private HNABleDeviceModel? device;

    public HNAMultiMeterConnectionDetailsViewModel(IHNABleService bleService)
    {
    ...
    public string DeviceSubtitle => Device?.Subtitle ?? "No connected MultiMeter was found.";
    ...
    private void UpdateDisplayProperties()
    {
        DeviceDisplayName = Device?.DisplayName
            ?? (string.IsNullOrWhiteSpace(DeviceName) ? "MultiMeter" : DeviceName);
